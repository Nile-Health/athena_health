module AthenaHealth
  module Endpoints
    module Configurations
      ...
      def all_procedures(practice_id:, search_value:)
        response = @api.call(
          endpoint: "#{practice_id}/reference/order/procedure",
          method: :get,
          params: { searchvalue: search_value }
        )

        response.map { |order_procedure| AthenaHealth::OrderProcedure.new(order_procedure)}
      end
      ...
      def all_order_types(practice_id:, params: {})
        response = @api.call(
          endpoint: "#{practice_id}/configuration/ordertype",
          method: :get,
          params: params
        )
